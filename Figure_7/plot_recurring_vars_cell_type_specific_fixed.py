...
_TARGET_CG = {"MEF2C exon 8", "DMD exon 71"}
recurrent = recurrent[recurrent["gene_exon"].isin(_TARGET_CG)].reset_index(drop=True)
print("[INFO] recurrent rows for C/G targets:", len(recurrent))
print(recurrent.to_string())
