...
# === Load data ===
effects_file = "/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/out_05_19_2025_boots_0_exon.csv"
df_effects = pd.read_csv(effects_file)

# === Output prefix for the plots ===
output_prefix = "/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/plots/effects_colored_by_cluster/exon"
...
# === Load data ===
effects_file = "/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/out_05_19_2025_boots_0_intron1.csv"
df_effects = pd.read_csv(effects_file)

# === Output prefix for the plots ===
output_prefix = "/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/plots/effects_colored_by_cluster/intron1"
