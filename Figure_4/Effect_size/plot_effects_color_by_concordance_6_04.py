...
# === Main ===
concordance_dir = "/ESL/Figures_SK/effect_size_final/out_08_10_2025/plots/concordance_updated_08_10_25"

for region in ["exon", "intron1", "intron2"]:
    effects_file = f"/ESL/Figures_SK/effect_size_final/out_08_10_2025/out_08_10_2025_boots_0_{region}.csv"
    df_effects = pd.read_csv(effects_file)

    concordant_dict, shared_concordant = load_all_concordance(concordance_dir, region)
    output_prefix = f"/ESL/Figures_SK/effect_size_final/out_08_10_2025/plots/effects_colored_by_cluster_concordant_fullticks_08_10_2025/{region}"
