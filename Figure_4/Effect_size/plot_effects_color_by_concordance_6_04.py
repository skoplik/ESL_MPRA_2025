...
# === Main ===
concordance_dir = "/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/plots/concordance_updated_08_10_25"

for region in ["exon", "intron1", "intron2"]:
    effects_file = f"/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/out_08_10_2025_boots_0_{region}.csv"
    df_effects = pd.read_csv(effects_file)

    concordant_dict, shared_concordant = load_all_concordance(concordance_dir, region)
    output_prefix = f"/ESL/ESL_MPRA/Figure_4/Effect_size/outputs/plots/effects_colored_by_cluster_concordant_fullticks_08_10_2025/{region}"
