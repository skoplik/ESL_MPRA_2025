...
def main(input_csv, output_prefix, clinvar_csv):
    ...
    TARGET_EID = "chr17:43079334-43079399:-"  # BRCA1 exon 13
    df_merged = df_merged[df_merged["event_id"].astype(str) == TARGET_EID]
    print("[INFO] rows for BRCA1 exon 13:", len(df_merged))
