...
# ── Legacy block (originally run on a small instance) ──────────────────────────
# These variable definitions and commands are kept for reference only.
# The active code below re-runs the analysis on the full instance with updated PSIs.
...
# ── Active: redo on full instance with updated PSIs ────────────────────────────
...
dbSNP_notes_supertable_file=$BASE_DIR/Figures/Population_variants/Resources/supertable_dbSNP155_Gencode_v26_overlap_dbSNP155_matches_all_notes.txt

PSI_file=$BASE_DIR/Figures/Variant_analyses/ClinVar/output_collapseRefEvents_psuedocount/HEK293_Reps_2023_09_WT_variants_pseudocount_matched_WT_mutant_PSIs.csv
dPSI_file=$BASE_DIR/Figures/Variant_analyses/ClinVar/output_collapseRefEvents_psuedocount/HEK293_Reps_2023_09_WT_variants_pseudocount_HEK293_deltaPSIs.csv
log2A_file=$BASE_DIR/Figures/Variant_analyses/ClinVar/output_collapseRefEvents_psuedocount/HEK293_Reps_2023_09_WT_variants_pseudocount_HEK293_log2As.csv
delta_logit_PSI=$BASE_DIR/Figures/Variant_analyses/ClinVar/output_collapseRefEvents_psuedocount/HEK293_Reps_2023_09_WT_variants_pseudocount_HEK293_delta_logit_PSIs.csv

output_dir=$BASE_DIR/Figures/Population_variants/figures_pseudocount/
...
dbSNP_study_supertable_file_prefix=$BASE_DIR/Figures/Resources/supertable_dbSNP155_Gencode_v26/supertable_dbSNP155_Gencode_v26_overlap_dbSNP155_matches
study_index=0

output_dir=$BASE_DIR/Figures/Population_variants/figures_pseudocount/dbSNP155_Gencode_v26_AF/
