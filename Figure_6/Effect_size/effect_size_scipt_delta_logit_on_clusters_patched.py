...
def main():
    ...
    #PATCHED:     df_intron1, df_exon, df_intron2 = open_split_data(output_path_prefix)
    #PATCHED:     psi_supertable_merged_df = pd.read_csv(f'{output_path_prefix}_psi_supetable_merged_NO_FIMO.csv') #no fimo data, just all sequences
