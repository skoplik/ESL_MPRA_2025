...
# === File path
input_file = "/ESL/ESL_MPRA/Figure_6/Effect_size/outputs/plots/unique_rbp_names.txt"
output_file = "/ESL/ESL_MPRA/Figure_6/Effect_size/outputs/plots/unique_rbp_names_with_aliases.csv"
